  ...
  en: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          id: 5,
          img: assetUrl("images/government/padron-beneficiarios/01-dashboard-general.png"),
          img2: assetUrl("images/government/padron-beneficiarios/02-catalogo-programas.png"),
          img3: assetUrl("images/government/padron-beneficiarios/03-registro-beneficiario.png"),
          img4: assetUrl("images/government/padron-beneficiarios/04-validacion-documental.png"),
          img5: assetUrl("images/government/padron-beneficiarios/05-seguimiento-dispersions.png"),
          img6: assetUrl("images/government/padron-beneficiarios/06-reportes-y-auditoria.png"),
          title: "Padrón de beneficiarios",
          description: "Government platform to centralize the full beneficiary lifecycle: registration, validation, program enrollment, payment tracking, incident management, and audit-ready reporting across all operational modules visible in the sidebar.",
          longDescription: "Padrón de beneficiarios is a government operations platform designed to provide full traceability of social program beneficiaries from initial intake to final follow-up. The system unifies modules typically distributed across different offices: beneficiaries registry, program and rules catalog, documentary validation, socio-economic assessment, assignment and enrollment, payment/dispersal tracking, incident handling, and analytics/audit reporting. Each module is role-aware and built for controlled workflows, allowing teams to collaborate without losing governance, data quality, or accountability. Its objective is to reduce manual fragmentation, prevent duplicate or invalid records, and give decision-makers a reliable, real-time operational view.",
          role: "Front-End Architect & Full-Stack Contributor",
          responsibilities: [
            "Designed a modular architecture mapped to each sidebar domain module for long-term maintainability.",
            "Implemented end-to-end workflows for beneficiary intake, document validation, and enrollment lifecycle states.",
            "Built role-based navigation and permissions for administrators, operators, reviewers, and supervisory roles.",
            "Integrated reporting dashboards for operational KPIs, traceability, and compliance-oriented audits.",
            "Standardized reusable UI patterns and data-table flows to keep consistency across all modules."
          ],
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          img6: assetUrl("images/government/padron-beneficiarios/06-reportes-y-auditoria.png"),
          title: "Padrón de beneficiarios",
          description: "Plataforma gubernamental para centralizar todo el ciclo de vida del beneficiario: registro, validación, asignación a programas, seguimiento de dispersiones, gestión de incidencias y reportes auditables en todos los módulos del sidebar.",
          longDescription: "Padrón de beneficiarios es una plataforma operativa de gobierno diseñada para dar trazabilidad completa a los beneficiarios de programas sociales, desde el alta inicial hasta el seguimiento final. El sistema unifica módulos que normalmente están dispersos entre diferentes áreas: padrón de beneficiarios, catálogo de programas y reglas de operación, validación documental, evaluación socioeconómica, asignación e incorporación, seguimiento de pagos/dispersiones, gestión de incidencias y reportes analíticos para auditoría. Cada módulo trabaja con controles por rol y flujos gobernados, permitiendo colaboración entre equipos sin perder calidad de datos, gobernanza ni rendición de cuentas. Su objetivo es reducir procesos manuales fragmentados, evitar duplicados o registros inválidos y ofrecer una vista operativa confiable en tiempo real para la toma de decisiones.",
          role: "Arquitecto Front-End y Colaborador Full-Stack",
          responsibilities: [
            "Diseñé una arquitectura modular alineada con cada módulo funcional del sidebar para asegurar escalabilidad.",
            "Implementé flujos de punta a punta para alta de beneficiarios, validación documental y estados del ciclo de incorporación.",
            "Construí navegación y permisos por rol para perfiles administradores, operadores, revisores y supervisión.",
            "Integré paneles de métricas operativas, trazabilidad y reportes orientados a cumplimiento y auditoría.",
            "Estandaricé patrones de UI reutilizables y flujos tabulares para mantener consistencia entre módulos."
          ],

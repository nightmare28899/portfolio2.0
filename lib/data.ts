      ...
      items: [
        {
          ...
          techStack: ["React Native", "TypeScript", "Styled Components", "Redux", "Axios", "AWS", "S3"],
          demo: "https://play.google.com/store/apps/details?id=com.clubamerica.redaguila_app&hl=es_MX",
          tags: ["React Native", "TypeScript", "Styled Components", "Redux", "Axios", "AWS", "S3"],
          type: "mobile",
      ...
      items: [
        {
          ...
          techStack: ["React Native", "TypeScript", "Styled Components", "Redux", "Axios"],
          tags: ["React Native", "TypeScript", "Styled Components", "Redux", "Axios"],
          type: "mobile",
          titleLink: "https://play.google.com/store/apps/details?id=com.clubamerica.redaguila_app&hl=es_MX",
        },
        {

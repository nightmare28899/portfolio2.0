...
export const DATA = {
  en: {
    ...
    hero: {
      role: "Full-Stack Developer | React, React Native, TypeScript, Laravel & Node.js",
      greeting: "Hello, I'm",
      headline: "Full-Stack Developer building production-ready web and mobile applications",
      description: "I build fast mobile apps and scalable web platforms with clean architecture, strong UX, and measurable business impact.",
      highlights: ["Remote-ready", "4+ years", "ES/EN"],
      ctaHire: "Hire Me",
    ...
    projects: {
      ...
      items: [
        ...
        {
          id: 4,
          img: assetUrl("images/government/data-datos-gratis/public-access/01-student-login-form.png"),
          img2: assetUrl("images/government/data-datos-gratis/student-registration/02-registration-step-1-personal-data.png"),
          img3: assetUrl("images/government/data-datos-gratis/student-registration/04-registration-step-3-institution.png"),
          img4: assetUrl("images/government/data-datos-gratis/student-registration/05-registration-success-summary.png"),
          img5: assetUrl("images/government/data-datos-gratis/admin-dashboard/01-student-requests-table.png"),
          img6: assetUrl("images/government/data-datos-gratis/admin-dashboard/03-update-request-status-modal.png"),
          title: "D4TA - Datos Gratis",
          description: "Government web platform for managing student applications to a free 4 GB monthly data program, with identity validation and institution-level approval workflows.",
          longDescription: "D4TA - Datos Gratis is a government initiative created to support students with a free 4 GB monthly data package for personal use. Students apply using CURP and school enrollment ID (matrícula), and the system validates that information before creating an application. Each successful registration generates a unique key that the student shares with their institution director to continue the process. Directors can review requests, while final lifecycle updates (approved/rejected/status changes) are restricted to superuser roles to preserve governance, auditability, and data integrity.",
          role: "Front-End Architect & Lead Developer",
          responsibilities: [
            ...
            "Built core modules with React.js, TypeScript, and Ant Design for an enterprise-grade experience.",
        ...
        {
          id: 5,
          img: assetUrl("images/government/padron-beneficiarios/01-padron-beneficiarios-home.png"),
          img2: assetUrl("images/government/padron-beneficiarios/02-padron-beneficiarios-login.png"),
          img3: assetUrl("images/government/padron-beneficiarios/03-dashboard-inicio.png"),
          img4: assetUrl("images/government/padron-beneficiarios/04-padron-programa-lista.png"),
          img5: assetUrl("images/government/padron-beneficiarios/05-reporte-graficas-aprobadas.png"),
          title: "Padrón de beneficiarios",
          description: "Government platform designed to centralize and govern the full beneficiary lifecycle across all operational modules shown in the left sidebar, from intake to reporting and oversight.",
          longDescription: "Padrón de beneficiarios is a government operations platform that consolidates every critical process required to manage social-program beneficiaries with traceability and control. Through the modules exposed in the left sidebar, teams can handle beneficiary onboarding, personal and documentary validation, program catalog and assignment, eligibility review, status transitions, disbursement monitoring, and analytical reporting in one governed workflow. The platform is built to reduce duplicate records, standardize inter-department coordination, and provide decision-makers with an auditable, real-time operational view of program execution.",
          role: "Front-End Architect & Full-Stack Contributor",
          responsibilities: [
            "Designed a modular frontend architecture aligned with each sidebar module for long-term scalability.",
            "Implemented end-to-end beneficiary flows: registration, validation, assignment, and status governance.",
            "Built role-aware interfaces and protected actions for operators, reviewers, and administrative stakeholders.",
            "Integrated reporting and KPI visualization to support audits, supervision, and operational decision-making.",
            "Standardized reusable components and data-table patterns across modules to keep consistency and speed delivery."
          ],
          techStack: ["React.js", "TypeScript", "Ant Design", "Zustand", "TanStack Query", "Axios", "Vite", "Modular Architecture"],
          tags: ["React.js", "TypeScript", "Ant Design", "Zustand", "TanStack Query", "Axios", "Vite", "Modular Architecture"],
          type: "web",
        },
        {
          id: 3,
  ...
  es: {
    ...
    hero: {
      ...
      greeting: "Hola, soy",
      headline: "Desarrollador Full-Stack creando aplicaciones web y móviles listas para producción",
      description: "Construyo apps móviles rápidas y plataformas web escalables con arquitectura limpia, buena UX e impacto de negocio medible.",
      highlights: ["Remoto", "4+ años", "ES/EN"],
      ctaHire: "Contrátame",
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          img6: assetUrl("images/government/data-datos-gratis/admin-dashboard/03-update-request-status-modal.png"),
          title: "D4TA - Datos Gratis",
          description: "Plataforma web gubernamental para gestionar solicitudes estudiantiles de un programa gratuito de 4 GB mensuales, con validación de identidad y flujos de aprobación institucional.",
          longDescription: "D4TA - Datos Gratis es una iniciativa del gobierno para apoyar a estudiantes con un paquete mensual gratuito de 4 GB para uso personal. El estudiante se registra con CURP y matrícula escolar, y el sistema valida la información antes de generar la solicitud. Al completar el proceso, se entrega una clave única que el estudiante comparte con el director de su institución para continuar el trámite. Los directores pueden revisar las solicitudes, y los cambios finales de estatus (aprobado/rechazado/actualizaciones) quedan restringidos a roles superusuario para asegurar gobernanza, trazabilidad e integridad de los datos.",
          role: "Arquitecto Front-End y Desarrollador Líder",
          responsibilities: [
            ...
            "Construí módulos clave con React.js, TypeScript y Ant Design para una experiencia robusta y mantenible.",
        ...
        },
        {
          ...
          img5: assetUrl("images/government/padron-beneficiarios/05-reporte-graficas-aprobadas.png"),
          title: "Padrón de beneficiarios",
          description: "Plataforma gubernamental diseñada para centralizar y gobernar el ciclo completo del beneficiario en todos los módulos operativos del sidebar izquierdo, desde el alta hasta la supervisión y reporteo.",
          longDescription: "Padrón de beneficiarios es una plataforma operativa de gobierno que consolida en un solo sistema todos los procesos críticos para administrar beneficiarios de programas sociales con trazabilidad y control. A través de los módulos visibles en el sidebar izquierdo, los equipos pueden gestionar alta de beneficiarios, validación personal y documental, catálogo y asignación a programas, revisión de elegibilidad, cambios de estatus, monitoreo de dispersiones y reportes analíticos bajo un flujo gobernado. La plataforma está orientada a reducir duplicidades, estandarizar la coordinación entre áreas y ofrecer a los tomadores de decisión una vista operativa auditable y en tiempo real sobre la ejecución de los programas.",
          role: "Arquitecto Front-End y Colaborador Full-Stack",
          responsibilities: [
            "Diseñé una arquitectura frontend modular alineada a cada módulo funcional del sidebar para escalar de forma sostenible.",
            "Implementé flujos de punta a punta para registro, validación, asignación y gobernanza de estatus de beneficiarios.",
            "Construí interfaces por rol y acciones protegidas para operadores, revisores y perfiles administrativos.",
            "Integré tableros de métricas y visualización de KPIs para auditoría, supervisión y toma de decisiones.",
            "Estandaricé componentes reutilizables y patrones de tablas para mantener consistencia y acelerar entregas."
          ],
          techStack: ["React.js", "TypeScript", "Ant Design", "Zustand", "TanStack Query", "Axios", "Vite", "Arquitectura Modular"],
          tags: ["React.js", "TypeScript", "Ant Design", "Zustand", "TanStack Query", "Axios", "Vite", "Arquitectura Modular"],
          type: "web",
        },
        {
          id: 3,
